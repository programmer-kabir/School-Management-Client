...
const Booked = () => {
  ...
  const onSubmit = async (data, product) => {
    ...
    data.classId = product?._id;
    axios.post(`${import.meta.env.VITE_LOCALHOST_KEY}/payment`, data);
  };
  return (
                          ...
                          <div className="px-4 py-6 sm:px-8 sm:py-7">
                            ...
                            >
                              <div className="space-y-2 ">
                                ...
                                {/* Address Star */}
                                <div class="space-y-5 flex gap-2 w-full items-center">
                                  ...
                                  <div className="w-full px-4">
                                    ...
                                    <div className="relative z-20 bg-white">
                                      <select className="block w-full px-3 py-2 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-cyan-600 caret-cyan-600">
                                        <option value="">
                                          Select a District
                                        </option>
                                    ...
                                    <div className="">
                                      ...
                                      <div className="relative z-20 bg-white">
                                        ...
                                        <select
                                          ...
                                          className="relative z-20 w-full appearance-none rounded-md border border-form-stroke bg-transparent py-3 px-12 text-[#929DA7] outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]"
                                        >
