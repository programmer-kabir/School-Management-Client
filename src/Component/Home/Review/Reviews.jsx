          ...
          {reviews &&
            reviews.map((review) => (
              <SwiperSlide key={review._id} className="mb-10   ">
                <div className="container flex  flex-col w-[392px]  p-4 mx-auto divide-y rounded-md divide-gray-700 dark:bg-gray-800 dark:text-gray-100">
                  ...
                  <div className=" pt-2 space-y-2 dark:text-gray-400">
